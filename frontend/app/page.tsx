      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            ...
            Manage students, teachers, attendance, grades, and finances all in one place.
          </p>
        ...
        <div className="mt-16 flex justify-center">
          <div className="w-full max-w-4xl h-64 bg-gradient-to-r from-blue-400 to-purple-500 rounded-lg shadow-2xl flex items-center justify-center">
            <span className="text-white text-2xl font-semibold">Dashboard Preview</span>
          </div>
        </div>
      </section>
