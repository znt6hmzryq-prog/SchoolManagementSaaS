                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                    ...
                                    <ul id="tocify-subheader-endpoints" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="endpoints-POSTapi-register-school">
                                <a href="#endpoints-POSTapi-register-school">POST api/register-school</a>
                            </li>
                                ...
                                <a href="#endpoints-POSTapi-logout">POST api/logout</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-super-admin-schools">
                                <a href="#endpoints-GETapi-super-admin-schools">GET api/super-admin/schools</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-super-admin-overview">
                                <a href="#endpoints-GETapi-super-admin-overview">GET api/super-admin/overview</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-admin-analytics-overview">
                                <a href="#endpoints-GETapi-admin-analytics-overview">GET api/admin/analytics/overview</a>
                            </li>
                                ...
                                <a href="#endpoints-GETapi-teachers--id-">GET api/teachers/{id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-teachers--id-">
                                <a href="#endpoints-PUTapi-teachers--id-">PUT api/teachers/{id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-teachers--id-">
                                <a href="#endpoints-DELETEapi-teachers--id-">DELETE api/teachers/{id}</a>
                            </li>
                                ...
                                <a href="#endpoints-POSTapi-academic-years">POST api/academic-years</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-academic-years--id-">
                                <a href="#endpoints-GETapi-academic-years--id-">GET api/academic-years/{id}</a>
                            </li>
                                ...
                                <a href="#endpoints-DELETEapi-academic-years--id-">DELETE api/academic-years/{id}</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-class-rooms">
                                <a href="#endpoints-GETapi-class-rooms">GET api/class-rooms</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-class-rooms">
                                <a href="#endpoints-POSTapi-class-rooms">POST api/class-rooms</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-class-rooms--id-">
                                <a href="#endpoints-GETapi-class-rooms--id-">GET api/class-rooms/{id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-class-rooms--id-">
                                <a href="#endpoints-PUTapi-class-rooms--id-">PUT api/class-rooms/{id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-class-rooms--id-">
                                <a href="#endpoints-DELETEapi-class-rooms--id-">DELETE api/class-rooms/{id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-sections">
                                <a href="#endpoints-GETapi-sections">GET api/sections</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-sections">
                                <a href="#endpoints-POSTapi-sections">POST api/sections</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-sections--id-">
                                <a href="#endpoints-GETapi-sections--id-">GET api/sections/{id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-sections--id-">
                                <a href="#endpoints-PUTapi-sections--id-">PUT api/sections/{id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-sections--id-">
                                <a href="#endpoints-DELETEapi-sections--id-">DELETE api/sections/{id}</a>
                            </li>
                                ...
                                <a href="#endpoints-DELETEapi-subjects--id-">DELETE api/subjects/{id}</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-teaching-assignments">
                                <a href="#endpoints-GETapi-teaching-assignments">GET api/teaching-assignments</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-teaching-assignments">
                                <a href="#endpoints-POSTapi-teaching-assignments">POST api/teaching-assignments</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-teaching-assignments--id-">
                                <a href="#endpoints-GETapi-teaching-assignments--id-">GET api/teaching-assignments/{id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-teaching-assignments--id-">
                                <a href="#endpoints-DELETEapi-teaching-assignments--id-">DELETE api/teaching-assignments/{id}</a>
                            </li>
                                ...
                                <a href="#endpoints-POSTapi-payments">POST api/payments</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-dashboard-financial">
                                <a href="#endpoints-GETapi-dashboard-financial">GET api/dashboard/financial</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-billing-subscribe">
                                <a href="#endpoints-POSTapi-billing-subscribe">POST api/billing/subscribe</a>
                            </li>
                                ...
                                <a href="#endpoints-POSTapi-attendances">POST api/attendances</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-attendances--id-">
                                <a href="#endpoints-GETapi-attendances--id-">GET api/attendances/{id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-attendances--id-">
                                <a href="#endpoints-DELETEapi-attendances--id-">DELETE api/attendances/{id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-class-rooms--classRoom_id--attach-subject">
                                <a href="#endpoints-POSTapi-class-rooms--classRoom_id--attach-subject">POST api/class-rooms/{classRoom_id}/attach-subject</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-subjects--subject_id--attach-teacher">
                                <a href="#endpoints-POSTapi-subjects--subject_id--attach-teacher">POST api/subjects/{subject_id}/attach-teacher</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-students--student--cgpa">
                                <a href="#endpoints-GETapi-students--student--cgpa">GET api/students/{student}/cgpa</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-dashboard-analytics">
                                <a href="#endpoints-GETapi-dashboard-analytics">GET api/dashboard/analytics</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-dashboard-risk-summary">
                                <a href="#endpoints-GETapi-dashboard-risk-summary">GET api/dashboard/risk-summary</a>
                            </li>
                                ...
                                <a href="#endpoints-POSTapi-notifications--id--read">POST api/notifications/{id}/read</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-files-upload">
                                <a href="#endpoints-POSTapi-files-upload">POST api/files/upload</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-files">
                                <a href="#endpoints-GETapi-files">GET api/files</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-files--file_id-">
                                <a href="#endpoints-DELETEapi-files--file_id-">DELETE api/files/{file_id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-teacher-dashboard">
                                <a href="#endpoints-GETapi-teacher-dashboard">GET api/teacher/dashboard</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-student-dashboard">
                                <a href="#endpoints-GETapi-student-dashboard">GET api/student/dashboard</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-parent-dashboard">
                                <a href="#endpoints-GETapi-parent-dashboard">GET api/parent/dashboard</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>This API is not authenticated.</p>
        ...
        <h1 id="endpoints">Endpoints</h1>
                                ...
                                <h2 id="endpoints-POSTapi-register-school">POST api/register-school</h2>
...
<div class="bash-example">
    ...
    --data "{
    \"school_name\": \"vmqeopfuudtdsufvyvddq\",
    \"admin_name\": \"amniihfqcoynlazghdtqt\",
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="school_name"                data-endpoint="POSTapi-register-school"
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-super-admin-schools">GET api/super-admin/schools</h2>
...
<span id="example-requests-GETapi-super-admin-schools">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/super-admin/schools" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/super-admin/schools"
);
...
<span id="example-responses-GETapi-super-admin-schools">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-super-admin-schools" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-super-admin-schools"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-super-admin-schools"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-super-admin-schools" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-super-admin-schools">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-super-admin-schools" data-method="GET"
      data-path="api/super-admin/schools"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-super-admin-schools', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-super-admin-schools"
                    onclick="tryItOut('GETapi-super-admin-schools');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-super-admin-schools"
                    onclick="cancelTryOut('GETapi-super-admin-schools');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-super-admin-schools"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/super-admin/schools</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-super-admin-schools"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-super-admin-schools"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-super-admin-overview">GET api/super-admin/overview</h2>
...
<span id="example-requests-GETapi-super-admin-overview">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/super-admin/overview" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/super-admin/overview"
);
...
<span id="example-responses-GETapi-super-admin-overview">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-super-admin-overview" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-super-admin-overview"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-super-admin-overview"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-super-admin-overview" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-super-admin-overview">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-super-admin-overview" data-method="GET"
      data-path="api/super-admin/overview"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-super-admin-overview', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-super-admin-overview"
                    onclick="tryItOut('GETapi-super-admin-overview');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-super-admin-overview"
                    onclick="cancelTryOut('GETapi-super-admin-overview');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-super-admin-overview"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/super-admin/overview</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-super-admin-overview"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-super-admin-overview"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-admin-analytics-overview">GET api/admin/analytics/overview</h2>
...
<span id="example-requests-GETapi-admin-analytics-overview">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/admin/analytics/overview" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<span id="example-responses-GETapi-admin-analytics-overview">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-admin-analytics-overview" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-admin-analytics-overview"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-admin-analytics-overview"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-admin-analytics-overview" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-admin-analytics-overview">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-admin-analytics-overview" data-method="GET"
      data-path="api/admin/analytics/overview"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-admin-analytics-overview', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-admin-analytics-overview"
                    onclick="tryItOut('GETapi-admin-analytics-overview');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-admin-analytics-overview"
                    onclick="cancelTryOut('GETapi-admin-analytics-overview');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-admin-analytics-overview"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/admin/analytics/overview</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-admin-analytics-overview"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-admin-analytics-overview"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="first_name"                data-endpoint="POSTapi-students"
               value="vmqeopfuudtdsufvyvddq"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>vmqeopfuudtdsufvyvddq</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="last_name"                data-endpoint="POSTapi-students"
               value="amniihfqcoynlazghdtqt"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>amniihfqcoynlazghdtqt</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="first_name"                data-endpoint="PUTapi-students--id-"
               value="vmqeopfuudtdsufvyvddq"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>vmqeopfuudtdsufvyvddq</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="last_name"                data-endpoint="PUTapi-students--id-"
               value="amniihfqcoynlazghdtqt"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>amniihfqcoynlazghdtqt</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="first_name"                data-endpoint="POSTapi-teachers"
               value="vmqeopfuudtdsufvyvddq"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>vmqeopfuudtdsufvyvddq</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="last_name"                data-endpoint="POSTapi-teachers"
               value="amniihfqcoynlazghdtqt"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>amniihfqcoynlazghdtqt</code></p>
...
<p>Must not be greater than 20 characters. Example: <code>wbpilpmufinllwloa</code></p>
                    ...
                    <h2 id="endpoints-GETapi-teachers--id-">GET api/teachers/{id}</h2>
...
<p>The ID of the teacher. Example: <code>17</code></p>
                    ...
                    <h2 id="endpoints-PUTapi-teachers--id-">PUT api/teachers/{id}</h2>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="first_name"                data-endpoint="PUTapi-teachers--id-"
               value="vmqeopfuudtdsufvyvddq"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>vmqeopfuudtdsufvyvddq</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="last_name"                data-endpoint="PUTapi-teachers--id-"
               value="amniihfqcoynlazghdtqt"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>amniihfqcoynlazghdtqt</code></p>
...
<p>Must not be greater than 20 characters. Example: <code>wbpilpmufinllwloa</code></p>
                    ...
                    <h2 id="endpoints-DELETEapi-teachers--id-">DELETE api/teachers/{id}</h2>
...
<div class="bash-example">
    ...
    \"start_date\": \"2026-03-08T21:59:03\",
    \"end_date\": \"2107-04-07\",
    \"is_active\": true
}"
</code></pre></div>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="name"                data-endpoint="POSTapi-academic-years"
               value="vmqeopfuudtdsufvyvddq"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>vmqeopfuudtdsufvyvddq</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               value="2026-03-08T21:59:03"
               data-component="body">
    <br>
<p>Must be a valid date. Example: <code>2026-03-08T21:59:03</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be a valid date. Must be a date after <code>start_date</code>. Example: <code>2107-04-07</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
                <label data-endpoint="POSTapi-academic-years" style="display: none">
            <input type="radio" name="is_active"
                   value="true"
                   data-endpoint="POSTapi-academic-years"
                   data-component="body"             >
            <code>true</code>
        </label>
        <label data-endpoint="POSTapi-academic-years" style="display: none">
...
<p>Example: <code>true</code></p>
                    ...
                    <h2 id="endpoints-GETapi-academic-years--id-">GET api/academic-years/{id}</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/academic-years/1" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/academic-years/1"
);
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="id"                data-endpoint="GETapi-academic-years--id-"
               value="1"
               data-component="url">
    <br>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="id"                data-endpoint="PUTapi-academic-years--id-"
               value="1"
               data-component="url">
    <br>
<p>The ID of the academic year. Example: <code>1</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="name"                data-endpoint="PUTapi-academic-years--id-"
               value="vmqeopfuudtdsufvyvddq"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>vmqeopfuudtdsufvyvddq</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <label data-endpoint="PUTapi-academic-years--id-" style="display: none">
            <input type="radio" name="is_active"
                   value="true"
                   data-endpoint="PUTapi-academic-years--id-"
                   data-component="body"             >
            <code>true</code>
        </label>
        <label data-endpoint="PUTapi-academic-years--id-" style="display: none">
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="id"                data-endpoint="DELETEapi-academic-years--id-"
               value="1"
               data-component="url">
    <br>
<p>The ID of the academic year. Example: <code>1</code></p>
                    ...
                    <h2 id="endpoints-GETapi-class-rooms">GET api/class-rooms</h2>
...
<span id="example-requests-GETapi-class-rooms">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/class-rooms" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/class-rooms"
);
...
<span id="example-responses-GETapi-class-rooms">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-class-rooms" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-class-rooms"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-class-rooms"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-class-rooms" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-class-rooms">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-class-rooms" data-method="GET"
      data-path="api/class-rooms"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-class-rooms', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-class-rooms"
                    onclick="tryItOut('GETapi-class-rooms');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-class-rooms"
                    onclick="cancelTryOut('GETapi-class-rooms');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-class-rooms"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-class-rooms"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-class-rooms"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-class-rooms">POST api/class-rooms</h2>
...
<span id="example-requests-POSTapi-class-rooms">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-POSTapi-class-rooms">
</span>
<span id="execution-results-POSTapi-class-rooms" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-class-rooms"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-class-rooms"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-class-rooms" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-class-rooms">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-class-rooms" data-method="POST"
      data-path="api/class-rooms"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-class-rooms', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-class-rooms"
                    onclick="tryItOut('POSTapi-class-rooms');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-class-rooms"
                    onclick="cancelTryOut('POSTapi-class-rooms');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-class-rooms"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-class-rooms"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-class-rooms"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="name"                data-endpoint="POSTapi-class-rooms"
               value="vmqeopfuudtdsufvyvddq"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>vmqeopfuudtdsufvyvddq</code></p>
                    ...
                    <h2 id="endpoints-GETapi-class-rooms--id-">GET api/class-rooms/{id}</h2>
...
<span id="example-requests-GETapi-class-rooms--id-">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/class-rooms/1" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/class-rooms/1"
);
...
<span id="example-responses-GETapi-class-rooms--id-">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-class-rooms--id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-class-rooms--id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-class-rooms--id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-class-rooms--id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-class-rooms--id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-class-rooms--id-" data-method="GET"
      data-path="api/class-rooms/{id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-class-rooms--id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-class-rooms--id-"
                    onclick="tryItOut('GETapi-class-rooms--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-class-rooms--id-"
                    onclick="cancelTryOut('GETapi-class-rooms--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-class-rooms--id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/class-rooms/{id}</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-class-rooms--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-class-rooms--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="id"                data-endpoint="GETapi-class-rooms--id-"
               value="1"
               data-component="url">
    <br>
<p>The ID of the class room. Example: <code>1</code></p>
            </div>
                    </form>

                    <h2 id="endpoints-PUTapi-class-rooms--id-">PUT api/class-rooms/{id}</h2>
...
<span id="example-requests-PUTapi-class-rooms--id-">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-PUTapi-class-rooms--id-">
</span>
<span id="execution-results-PUTapi-class-rooms--id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-PUTapi-class-rooms--id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-PUTapi-class-rooms--id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-PUTapi-class-rooms--id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-PUTapi-class-rooms--id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-PUTapi-class-rooms--id-" data-method="PUT"
      data-path="api/class-rooms/{id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('PUTapi-class-rooms--id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-PUTapi-class-rooms--id-"
                    onclick="tryItOut('PUTapi-class-rooms--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PUTapi-class-rooms--id-"
                    onclick="cancelTryOut('PUTapi-class-rooms--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-PUTapi-class-rooms--id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="PUTapi-class-rooms--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="PUTapi-class-rooms--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="id"                data-endpoint="PUTapi-class-rooms--id-"
               value="1"
               data-component="url">
    <br>
<p>The ID of the class room. Example: <code>1</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="name"                data-endpoint="PUTapi-class-rooms--id-"
               value="vmqeopfuudtdsufvyvddq"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>vmqeopfuudtdsufvyvddq</code></p>
                    ...
                    <h2 id="endpoints-DELETEapi-class-rooms--id-">DELETE api/class-rooms/{id}</h2>
...
<span id="example-requests-DELETEapi-class-rooms--id-">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-DELETEapi-class-rooms--id-">
</span>
<span id="execution-results-DELETEapi-class-rooms--id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-DELETEapi-class-rooms--id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-DELETEapi-class-rooms--id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-DELETEapi-class-rooms--id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-DELETEapi-class-rooms--id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-DELETEapi-class-rooms--id-" data-method="DELETE"
      data-path="api/class-rooms/{id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('DELETEapi-class-rooms--id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-DELETEapi-class-rooms--id-"
                    onclick="tryItOut('DELETEapi-class-rooms--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-DELETEapi-class-rooms--id-"
                    onclick="cancelTryOut('DELETEapi-class-rooms--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-DELETEapi-class-rooms--id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="DELETEapi-class-rooms--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="DELETEapi-class-rooms--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="id"                data-endpoint="DELETEapi-class-rooms--id-"
               value="1"
               data-component="url">
    <br>
<p>The ID of the class room. Example: <code>1</code></p>
                    ...
                    <h2 id="endpoints-GETapi-sections">GET api/sections</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-sections">POST api/sections</h2>
...
<p>Example: <code>application/json</code></p>
                                ...
                                <h4 class="fancy-heading-panel"><b>Body Parameters</b></h4>
        <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>class_room_id</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="class_room_id"                data-endpoint="POSTapi-sections"
               value="consequatur"
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the class_rooms table. Example: <code>consequatur</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>name</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
...
<p>Must not be greater than 10 characters. Example: <code>mqeopfuud</code></p>
                    ...
                    <h2 id="endpoints-GETapi-sections--id-">GET api/sections/{id}</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/sections/1" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<p>The ID of the section. Example: <code>1</code></p>
                    ...
                    <h2 id="endpoints-PUTapi-sections--id-">PUT api/sections/{id}</h2>
...
<p>The ID of the section. Example: <code>1</code></p>
                    ...
                    <h2 id="endpoints-DELETEapi-sections--id-">DELETE api/sections/{id}</h2>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="academic_year_id"                data-endpoint="POSTapi-subjects"
               value="consequatur"
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the academic_years table. Example: <code>consequatur</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>name</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="code"                data-endpoint="POSTapi-subjects"
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="code"                data-endpoint="PUTapi-subjects--id-"
               value="amniihfqcoynlazghdtqt"
               data-component="body">
    <br>
...
<p>The ID of the subject. Example: <code>17</code></p>
                    ...
                    <h2 id="endpoints-GETapi-teaching-assignments">GET api/teaching-assignments</h2>
...
<span id="example-requests-GETapi-teaching-assignments">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/teaching-assignments" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/teaching-assignments"
);
...
<span id="example-responses-GETapi-teaching-assignments">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-teaching-assignments" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-teaching-assignments"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-teaching-assignments"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-teaching-assignments" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-teaching-assignments">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-teaching-assignments" data-method="GET"
      data-path="api/teaching-assignments"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-teaching-assignments', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-teaching-assignments"
                    onclick="tryItOut('GETapi-teaching-assignments');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-teaching-assignments"
                    onclick="cancelTryOut('GETapi-teaching-assignments');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-teaching-assignments"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/teaching-assignments</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-teaching-assignments"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-teaching-assignments"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-teaching-assignments">POST api/teaching-assignments</h2>
...
<span id="example-requests-POSTapi-teaching-assignments">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-POSTapi-teaching-assignments">
</span>
<span id="execution-results-POSTapi-teaching-assignments" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-teaching-assignments"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-teaching-assignments"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-teaching-assignments" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-teaching-assignments">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-teaching-assignments" data-method="POST"
      data-path="api/teaching-assignments"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-teaching-assignments', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-teaching-assignments"
                    onclick="tryItOut('POSTapi-teaching-assignments');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-teaching-assignments"
                    onclick="cancelTryOut('POSTapi-teaching-assignments');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-teaching-assignments"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-teaching-assignments"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-teaching-assignments"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="academic_year_id"                data-endpoint="POSTapi-teaching-assignments"
               value="consequatur"
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the academic_years table. Example: <code>consequatur</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="class_room_id"                data-endpoint="POSTapi-teaching-assignments"
               value="consequatur"
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the class_rooms table. Example: <code>consequatur</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="subject_id"                data-endpoint="POSTapi-teaching-assignments"
               value="consequatur"
               data-component="body">
    <br>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="teacher_id"                data-endpoint="POSTapi-teaching-assignments"
               value="consequatur"
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the teachers table. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-GETapi-teaching-assignments--id-">GET api/teaching-assignments/{id}</h2>
...
<span id="example-requests-GETapi-teaching-assignments--id-">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/teaching-assignments/17" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/teaching-assignments/17"
);
...
<span id="example-responses-GETapi-teaching-assignments--id-">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-teaching-assignments--id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-teaching-assignments--id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-teaching-assignments--id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-teaching-assignments--id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-teaching-assignments--id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-teaching-assignments--id-" data-method="GET"
      data-path="api/teaching-assignments/{id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-teaching-assignments--id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-teaching-assignments--id-"
                    onclick="tryItOut('GETapi-teaching-assignments--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-teaching-assignments--id-"
                    onclick="cancelTryOut('GETapi-teaching-assignments--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-teaching-assignments--id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/teaching-assignments/{id}</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-teaching-assignments--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-teaching-assignments--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="id"                data-endpoint="GETapi-teaching-assignments--id-"
               value="17"
               data-component="url">
    <br>
<p>The ID of the teaching assignment. Example: <code>17</code></p>
            </div>
                    </form>

                    <h2 id="endpoints-DELETEapi-teaching-assignments--id-">DELETE api/teaching-assignments/{id}</h2>
...
<span id="example-requests-DELETEapi-teaching-assignments--id-">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-DELETEapi-teaching-assignments--id-">
</span>
<span id="execution-results-DELETEapi-teaching-assignments--id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-DELETEapi-teaching-assignments--id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-DELETEapi-teaching-assignments--id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-DELETEapi-teaching-assignments--id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-DELETEapi-teaching-assignments--id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-DELETEapi-teaching-assignments--id-" data-method="DELETE"
      data-path="api/teaching-assignments/{id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('DELETEapi-teaching-assignments--id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-DELETEapi-teaching-assignments--id-"
                    onclick="tryItOut('DELETEapi-teaching-assignments--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-DELETEapi-teaching-assignments--id-"
                    onclick="cancelTryOut('DELETEapi-teaching-assignments--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-DELETEapi-teaching-assignments--id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="DELETEapi-teaching-assignments--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="DELETEapi-teaching-assignments--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="id"                data-endpoint="DELETEapi-teaching-assignments--id-"
               value="17"
               data-component="url">
    <br>
<p>The ID of the teaching assignment. Example: <code>17</code></p>
...
<div class="bash-example">
    ...
    --header "Accept: application/json" \
    --data "{
    \"teaching_assignment_id\": \"consequatur\",
    \"title\": \"mqeopfuudtdsufvyvddqa\",
    \"type\": \"project\",
    \"max_score\": 45,
    \"weight\": 46,
    \"assessment_date\": \"2026-03-08T21:59:05\"
}"
</code></pre></div>
...
<p>Example: <code>application/json</code></p>
                                ...
                                <h4 class="fancy-heading-panel"><b>Body Parameters</b></h4>
        <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>teaching_assignment_id</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="teaching_assignment_id"                data-endpoint="POSTapi-assessments"
               value="consequatur"
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the teaching_assignments table. Example: <code>consequatur</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="type"                data-endpoint="POSTapi-assessments"
               value="project"
               data-component="body">
    <br>
<p>Example: <code>project</code></p>
Must be one of:
<ul style="list-style-type: square;"><li><code>quiz</code></li> <li><code>homework</code></li> <li><code>midterm</code></li> <li><code>final</code></li> <li><code>project</code></li> <li><code>assignment</code></li></ul>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>number</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="weight"                data-endpoint="POSTapi-assessments"
               value="46"
               data-component="body">
    <br>
<p>Must be at least 0.01. Example: <code>46</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="assessment_date"                data-endpoint="POSTapi-assessments"
               value="2026-03-08T21:59:05"
               data-component="body">
    <br>
<p>Must be a valid date. Example: <code>2026-03-08T21:59:05</code></p>
        </div>
        </form>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/assessments/17" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/assessments/17"
);
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="url">
    <br>
<p>The ID of the assessment. Example: <code>17</code></p>
            </div>
                    </form>
...
<div class="bash-example">
    ...
    \"max_score\": 1,
    \"weight\": 45,
    \"assessment_date\": \"2026-03-08T21:59:06\"
}"
</code></pre></div>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="type"                data-endpoint="PUTapi-assessments--id-"
               value="project"
               data-component="body">
    <br>
<p>Example: <code>project</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be at least 0.01. Example: <code>1</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>weight</code></b>&nbsp;&nbsp;
<small>number</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="weight"                data-endpoint="PUTapi-assessments--id-"
               value="45"
               data-component="body">
    <br>
<p>Must be at least 0.01. Example: <code>45</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="assessment_date"                data-endpoint="PUTapi-assessments--id-"
               value="2026-03-08T21:59:06"
               data-component="body">
    <br>
<p>Must be a valid date. Example: <code>2026-03-08T21:59:06</code></p>
        </div>
        </form>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="assessment_id"                data-endpoint="POSTapi-grades"
               value="consequatur"
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the assessments table. Example: <code>consequatur</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>number</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="score"                data-endpoint="POSTapi-grades"
               value="45"
               data-component="body">
    <br>
...
<small>number</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="score"                data-endpoint="PUTapi-grades--id-"
               value="73"
               data-component="body">
    <br>
...
<div class="bash-example">
    ...
    --header "Accept: application/json" \
    --data "{
    \"student_fee_assignment_id\": \"consequatur\",
    \"due_date\": \"2026-03-08T21:59:06\"
}"
</code></pre></div>
...
<p>Example: <code>application/json</code></p>
                                ...
                                <h4 class="fancy-heading-panel"><b>Body Parameters</b></h4>
        <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>student_fee_assignment_id</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="student_fee_assignment_id"                data-endpoint="POSTapi-invoices"
               value="consequatur"
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the student_fee_assignments table. Example: <code>consequatur</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<p>Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-GETapi-dashboard-financial">GET api/dashboard/financial</h2>
...
<span id="example-requests-GETapi-dashboard-financial">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/dashboard/financial" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/dashboard/financial"
);
...
<span id="example-responses-GETapi-dashboard-financial">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-dashboard-financial" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-dashboard-financial"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-dashboard-financial"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-dashboard-financial" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-dashboard-financial">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-dashboard-financial" data-method="GET"
      data-path="api/dashboard/financial"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-dashboard-financial', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-dashboard-financial"
                    onclick="tryItOut('GETapi-dashboard-financial');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-dashboard-financial"
                    onclick="cancelTryOut('GETapi-dashboard-financial');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-dashboard-financial"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/dashboard/financial</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-dashboard-financial"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-dashboard-financial"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-billing-subscribe">POST api/billing/subscribe</h2>
...
<span id="example-requests-POSTapi-billing-subscribe">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost/api/billing/subscribe" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
...
<span id="example-responses-POSTapi-billing-subscribe">
</span>
<span id="execution-results-POSTapi-billing-subscribe" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-billing-subscribe"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-billing-subscribe"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-billing-subscribe" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-billing-subscribe">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-billing-subscribe" data-method="POST"
      data-path="api/billing/subscribe"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-billing-subscribe', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-billing-subscribe"
                    onclick="tryItOut('POSTapi-billing-subscribe');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-billing-subscribe"
                    onclick="cancelTryOut('POSTapi-billing-subscribe');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-billing-subscribe"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/billing/subscribe</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-billing-subscribe"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-billing-subscribe"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="plan_type"                data-endpoint="POSTapi-billing-subscribe"
               value="enterprise"
               data-component="body">
    <br>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/attendances" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-attendances">POST api/attendances</h2>
...
<div class="bash-example">
    ...
    \"teaching_assignment_id\": \"consequatur\",
    \"student_id\": \"consequatur\",
    \"attendance_date\": \"2026-03-08T21:59:07\",
    \"status\": \"absent\"
}"
</code></pre></div>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="teaching_assignment_id"                data-endpoint="POSTapi-attendances"
               value="consequatur"
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the teaching_assignments table. Example: <code>consequatur</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="student_id"                data-endpoint="POSTapi-attendances"
               value="consequatur"
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the students table. Example: <code>consequatur</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="attendance_date"                data-endpoint="POSTapi-attendances"
               value="2026-03-08T21:59:07"
               data-component="body">
    <br>
<p>Must be a valid date. Example: <code>2026-03-08T21:59:07</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<ul style="list-style-type: square;"><li><code>present</code></li> <li><code>absent</code></li> <li><code>late</code></li> <li><code>excused</code></li></ul>
                    ...
                    <h2 id="endpoints-GETapi-attendances--id-">GET api/attendances/{id}</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/attendances/17" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/attendances/17"
);
...
<p>The ID of the attendance. Example: <code>17</code></p>
                    ...
                    <h2 id="endpoints-DELETEapi-attendances--id-">DELETE api/attendances/{id}</h2>
...
<p>The ID of the attendance. Example: <code>17</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-class-rooms--classRoom_id--attach-subject">POST api/class-rooms/{classRoom_id}/attach-subject</h2>
...
<span id="example-requests-POSTapi-class-rooms--classRoom_id--attach-subject">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost/api/class-rooms/1/attach-subject" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"subject_id\": \"consequatur\"
...
<span id="example-responses-POSTapi-class-rooms--classRoom_id--attach-subject">
</span>
<span id="execution-results-POSTapi-class-rooms--classRoom_id--attach-subject" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-class-rooms--classRoom_id--attach-subject"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-class-rooms--classRoom_id--attach-subject"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-class-rooms--classRoom_id--attach-subject" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-class-rooms--classRoom_id--attach-subject">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-class-rooms--classRoom_id--attach-subject" data-method="POST"
      data-path="api/class-rooms/{classRoom_id}/attach-subject"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-class-rooms--classRoom_id--attach-subject', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-class-rooms--classRoom_id--attach-subject"
                    onclick="tryItOut('POSTapi-class-rooms--classRoom_id--attach-subject');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-class-rooms--classRoom_id--attach-subject"
                    onclick="cancelTryOut('POSTapi-class-rooms--classRoom_id--attach-subject');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-class-rooms--classRoom_id--attach-subject"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/class-rooms/{classRoom_id}/attach-subject</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-class-rooms--classRoom_id--attach-subject"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-class-rooms--classRoom_id--attach-subject"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="classRoom_id"                data-endpoint="POSTapi-class-rooms--classRoom_id--attach-subject"
               value="1"
               data-component="url">
    <br>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="subject_id"                data-endpoint="POSTapi-class-rooms--classRoom_id--attach-subject"
               value="consequatur"
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the subjects table. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-subjects--subject_id--attach-teacher">POST api/subjects/{subject_id}/attach-teacher</h2>
...
<span id="example-requests-POSTapi-subjects--subject_id--attach-teacher">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost/api/subjects/17/attach-teacher" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"teacher_id\": \"consequatur\"
...
<span id="example-responses-POSTapi-subjects--subject_id--attach-teacher">
</span>
<span id="execution-results-POSTapi-subjects--subject_id--attach-teacher" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-subjects--subject_id--attach-teacher"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-subjects--subject_id--attach-teacher"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-subjects--subject_id--attach-teacher" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-subjects--subject_id--attach-teacher">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-subjects--subject_id--attach-teacher" data-method="POST"
      data-path="api/subjects/{subject_id}/attach-teacher"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-subjects--subject_id--attach-teacher', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-subjects--subject_id--attach-teacher"
                    onclick="tryItOut('POSTapi-subjects--subject_id--attach-teacher');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-subjects--subject_id--attach-teacher"
                    onclick="cancelTryOut('POSTapi-subjects--subject_id--attach-teacher');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-subjects--subject_id--attach-teacher"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/subjects/{subject_id}/attach-teacher</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-subjects--subject_id--attach-teacher"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-subjects--subject_id--attach-teacher"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="subject_id"                data-endpoint="POSTapi-subjects--subject_id--attach-teacher"
               value="17"
               data-component="url">
    <br>
<p>The ID of the subject. Example: <code>17</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="teacher_id"                data-endpoint="POSTapi-subjects--subject_id--attach-teacher"
               value="consequatur"
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the teachers table. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-GETapi-students--student--cgpa">GET api/students/{student}/cgpa</h2>
...
<span id="example-requests-GETapi-students--student--cgpa">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/students/1/cgpa" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/students/1/cgpa"
);
...
<span id="example-responses-GETapi-students--student--cgpa">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-students--student--cgpa" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-students--student--cgpa"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-students--student--cgpa"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-students--student--cgpa" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-students--student--cgpa">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-students--student--cgpa" data-method="GET"
      data-path="api/students/{student}/cgpa"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-students--student--cgpa', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-students--student--cgpa"
                    onclick="tryItOut('GETapi-students--student--cgpa');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-students--student--cgpa"
                    onclick="cancelTryOut('GETapi-students--student--cgpa');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-students--student--cgpa"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/students/{student}/cgpa</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-students--student--cgpa"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-students--student--cgpa"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="student"                data-endpoint="GETapi-students--student--cgpa"
               value="1"
               data-component="url">
    <br>
<p>The student. Example: <code>1</code></p>
                    ...
                    <h2 id="endpoints-GETapi-dashboard-analytics">GET api/dashboard/analytics</h2>
...
<span id="example-requests-GETapi-dashboard-analytics">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/dashboard/analytics" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/dashboard/analytics"
);
...
<span id="example-responses-GETapi-dashboard-analytics">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-dashboard-analytics" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-dashboard-analytics"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-dashboard-analytics"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-dashboard-analytics" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-dashboard-analytics">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-dashboard-analytics" data-method="GET"
      data-path="api/dashboard/analytics"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-dashboard-analytics', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-dashboard-analytics"
                    onclick="tryItOut('GETapi-dashboard-analytics');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-dashboard-analytics"
                    onclick="cancelTryOut('GETapi-dashboard-analytics');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-dashboard-analytics"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/dashboard/analytics</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-dashboard-analytics"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-dashboard-analytics"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-dashboard-risk-summary">GET api/dashboard/risk-summary</h2>
...
<span id="example-requests-GETapi-dashboard-risk-summary">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/dashboard/risk-summary" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/dashboard/risk-summary"
);
...
<span id="example-responses-GETapi-dashboard-risk-summary">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-dashboard-risk-summary" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-dashboard-risk-summary"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-dashboard-risk-summary"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-dashboard-risk-summary" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-dashboard-risk-summary">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-dashboard-risk-summary" data-method="GET"
      data-path="api/dashboard/risk-summary"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-dashboard-risk-summary', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-dashboard-risk-summary"
                    onclick="tryItOut('GETapi-dashboard-risk-summary');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-dashboard-risk-summary"
                    onclick="cancelTryOut('GETapi-dashboard-risk-summary');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-dashboard-risk-summary"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/dashboard/risk-summary</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-dashboard-risk-summary"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-dashboard-risk-summary"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<p>The ID of the notification. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-files-upload">POST api/files/upload</h2>
...
<span id="example-requests-POSTapi-files-upload">
<blockquote>Example request:</blockquote>
...
<div class="bash-example">
    ...
    --header "Accept: application/json" \
    --form "file=@C:\Users\t\AppData\Local\Temp\php3FE.tmp" </code></pre></div>
...
<span id="example-responses-POSTapi-files-upload">
</span>
<span id="execution-results-POSTapi-files-upload" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-files-upload"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-files-upload"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-files-upload" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-files-upload">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-files-upload" data-method="POST"
      data-path="api/files/upload"
      data-authed="0"
      data-hasfiles="1"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-files-upload', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-files-upload"
                    onclick="tryItOut('POSTapi-files-upload');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-files-upload"
                    onclick="cancelTryOut('POSTapi-files-upload');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-files-upload"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/files/upload</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-files-upload"
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-files-upload"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>file</small>&nbsp;
 ...
 &nbsp;
                <input type="file" style="display: none"
                              name="file"                data-endpoint="POSTapi-files-upload"
               value=""
               data-component="body">
    <br>
<p>Must be a file. Must not be greater than 10240 kilobytes. Example: <code>C:\Users\t\AppData\Local\Temp\php3FE.tmp</code></p>
        </div>
        </form>

                    <h2 id="endpoints-GETapi-files">GET api/files</h2>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-files"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-files"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-DELETEapi-files--file_id-">DELETE api/files/{file_id}</h2>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="DELETEapi-files--file_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="DELETEapi-files--file_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="url">
    <br>
<p>The ID of the file. Example: <code>17</code></p>
            </div>
                    </form>

                    <h2 id="endpoints-GETapi-teacher-dashboard">GET api/teacher/dashboard</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-student-dashboard">GET api/student/dashboard</h2>
...
<span id="example-requests-GETapi-student-dashboard">
<blockquote>Example request:</blockquote>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/student/dashboard"
);
...
<span id="example-responses-GETapi-student-dashboard">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-student-dashboard" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-student-dashboard"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-student-dashboard"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-student-dashboard" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-student-dashboard">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-student-dashboard" data-method="GET"
      data-path="api/student/dashboard"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-student-dashboard', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-student-dashboard"
                    onclick="tryItOut('GETapi-student-dashboard');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-student-dashboard"
                    onclick="cancelTryOut('GETapi-student-dashboard');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-student-dashboard"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/student/dashboard</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-student-dashboard"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-student-dashboard"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-parent-dashboard">GET api/parent/dashboard</h2>
...
<span id="example-requests-GETapi-parent-dashboard">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/parent/dashboard" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/parent/dashboard"
);
...
<span id="example-responses-GETapi-parent-dashboard">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-parent-dashboard" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-parent-dashboard"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-parent-dashboard"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-parent-dashboard" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-parent-dashboard">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-parent-dashboard" data-method="GET"
      data-path="api/parent/dashboard"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-parent-dashboard', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-parent-dashboard"
                    onclick="tryItOut('GETapi-parent-dashboard');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-parent-dashboard"
                    onclick="cancelTryOut('GETapi-parent-dashboard');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-parent-dashboard"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/parent/dashboard</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-parent-dashboard"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-parent-dashboard"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
